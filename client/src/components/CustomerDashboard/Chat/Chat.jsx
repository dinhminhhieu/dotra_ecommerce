...
const Chat = () => {
  const { BsEmojiSmile, AiOutlinePlus, IoSend } = icons;
          ...
          {current_friend ? (
            <div className="w-full h-full">
              ...
              <div className="flex p-2 justify-between items-center w-full">
                ...
                <div className="border-1 w-[calc(100%-90px)] rounded-full relative overflow-visible">
                  <input
                    type="text"
            ...
            <div className="w-full h-full flex justify-center items-center flex-col text-lg text-white font-bold bg-[#b3b3b3]">
              <span>
