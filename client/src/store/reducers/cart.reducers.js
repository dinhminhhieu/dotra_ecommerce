...
// 1. Reducer thêm sản phẩm vào giỏ hàng
...
// 2. Reducer lấy sản phẩm trong giỏ hàng
...
// 3. Reducer xoá sản phẩm khỏi giỏ hàng
export const delete_product_cart = createAsyncThunk(
...
// 4. Reducer tăng số lượng sản phẩm trong giỏ hàng
export const increase_quantity = createAsyncThunk(
...
// 5. Reducer giảm số lượng sản phẩm trong giỏ hàng
export const decrease_quantity = createAsyncThunk(
...
// 6. Reducer áp dụng mã giảm giá
export const apply_coupons = createAsyncThunk(
  "cart/apply_coupons",
  async (body, thunkAPI) => {
    try {
