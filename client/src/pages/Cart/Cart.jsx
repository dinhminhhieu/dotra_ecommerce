        ...
        <div className="w-[85%] lg:w-[90%] md:w-[90%] sm:w-[90] mx-auto py-16">
          {cart.length > 0 || out_of_stock.length > 0 ? (
                                    ...
                                    <Modal.Body>
                                      <div className="text-center">
                                        ...
                                        <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                          Bạn muốn xóa sản phẩm này ra khỏi giỏ
                                          hàng?
                                        </h3>
                    ...
                    <div className="bg-white p-3 text-slate-600 flex flex-col gap-3">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <button
                            type="submit"
                            className="px-8 py-[1px] bg-red-500 text-white rounded-sm uppercase text-sm"
                          >
                            Apply
                          </button>
                        </form>
            ...
            <div>
              ...
              <Link to={path.shop} className="px-4 py-2 bg-red-500 text-white">
                Mua Ngay
              </Link>
            </div>
          )}
