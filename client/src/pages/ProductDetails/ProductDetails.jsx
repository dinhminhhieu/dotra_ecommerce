...
const ProductDetails = () => {
  ...
  const { product_details, related_products, more_products } = useSelector(
    (state) => state.home
  );
  ...
  return (
    <div>
      <Header />
      <div className='bg-[url("/src/assets/banners/5.png")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
      ...
      <section>
        <div className="w-[70%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto pb-16">
          <div className="grid grid-cols-2 md-lg:grid-cols-1 gap-8">
            <div>
              <div className="p-5 border h-[450px] w-[450px]">
                <img
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex gap-3 pb-10 border-b">
                {product_details.quantity ? (
                  <>
                    <div className="flex bg-slate-200 h-[45px] rounded-md justify-center items-center">
                      <div
                    ...
                    <div>
                      <button
                        ...
                        className="px-6 py-3 h-[45px] rounded-md cursor-pointer hover:shadow-lg text-sm hover:shadow-purple-500/40 bg-red-500 text-white"
                      >
                        Thêm vào giỏ hàng
                      </button>
                    </div>
              ...
              <div className="flex py-5 gap-5">
                ...
                <div className="flex flex-col gap-5">
                  <span
                    className={`text-${
                      product_details.quantity ? "green" : "red"
                    }-500 font-semibold`}
                  >
                    {product_details.quantity
              ...
              <div className="flex gap-3 text-sm">
                {product_details.quantity ? (
                  <button className="px-5 py-3 h-[45px] rounded-md cursor-pointer hover:shadow-lg hover:shadow-red-500/40 bg-red-500 text-white">
                    Mua ngay
                  </button>
                ) : (
                  ""
          ...
          <div className="flex flex-wrap">
            ...
            <div className="w-[28%] md-lg:w-full">
              <div className="pl-4 md-lg:pl-0">
                <div className="px-3 py-2 text-white text-center rounded-md bg-red-500">
                    ...
                    return (
                      ...
                      >
                        <div className="relative overflow-hidden">
                          ...
                          <img
                            className="sm:w-full w-full h-[220px] p-6"
                            src={w.images[0]}
                            alt=""
                          />
                        </div>
