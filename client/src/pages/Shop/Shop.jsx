...
import {
  ...
  query_products,
} from "../../store/reducers/home.reducers";
...
const Shop = () => {
  ...
  const { categories, products, latest_products, totalProducts } = useSelector(
    (state) => state.home
  );
  ...
  return (
    <div>
      <Header />
      <section className='bg-[url("/src/assets/banners/2.png")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
                ...
                {categories.map((c) => (
                  ...
                  >
                    <input
                      ...
                      onChange={(event) =>
                        queryCategory(event, c.category_name)
                      }
                      type="checkbox"
