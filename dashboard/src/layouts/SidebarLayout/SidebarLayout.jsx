...
const SidebarLayout = ({ showSidebar, setShowSidebar }) => {
  ...
  return (
    <div>
      ...
      ></div>
      <div
        className={`w-[260px] fixed z-50 top-0 h-screen shadow-[0_0_15px_0_rgb(34_41_47_/_5%)] transition-all ${
            ...
            {allNavbar.map((n, i) => (
              <li key={i} className="mb-6">
                <Link
                  ...
                  className={`${
                    pathname === n.path
                      ? "bg-slate-600 shadow-indigo-500/30 text-white text-base duration-500 rounded-xl mt-2"
                      : "text-gray-700 font-normal duration-200"
