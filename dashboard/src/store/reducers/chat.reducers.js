...
// 1. Reducer lấy danh sách customer đang chat
...
// 2. Reducer lấy tin nhắn của customer trả về seller
...
// 3. Reducer gửi tin nhắn từ seller đến customer
...
// 4. Reducer lấy danh sách seller đang chat
...
// 5. Reducer gửi tin nhắn từ seller đến admin
...
// 6. Reducer lấy tin nhắn của seller đến admin
...
export const chatSlice = createSlice({
  ...
  reducers: {
    ...
    update_active_cutomer: (state, action) => {
