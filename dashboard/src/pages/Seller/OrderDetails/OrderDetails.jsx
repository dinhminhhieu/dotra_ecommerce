      ...
      <div className="p-5">
        ...
        <div className="grid grid-cols-1 gap-3">
          <div className="flex flex-col gap-1">
            ...
            <span className="font-semibold mb-1 rounded">
              Đơn vị giao hàng: {order_details.shippingInfo}
            </span>
          </div>
        </div>
          ...
          <div className="my-2">
            ...
            <ul className="timeline">
              ...
              <li>
                ...
                {order_details.delivery_status === "processing" ? (
                  <hr />
                ) : (
              ...
              <li>
                ...
                <div className="timeline-end timeline-box">Đang vận chuyển</div>
                {order_details.delivery_status === "delivered" ? (
                  <hr className="bg-primary" />
                ) : (
                  <hr />
