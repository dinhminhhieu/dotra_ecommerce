...
const Login = () => {
  ...
  return (
    <div className="flex justify-between min-h-screen font-sans">
      <div className=" relative w-1/2 bg-center bg-cover bg-hero-pattern lg:block"></div>
      <div className="flex-1 mx-auto max-w-2xl">
        <div className="flex flex-col px-8 pt-10 lg:px-14 xl:px-24">
          ...
          <div className="pt-5 pb-3">
            ...
            <div className="flex gap-y-4 gap-x-6 justify-center items-center pt-5 whitespace-nowrap">
              <button className="flex items-center justify-center flex-1 py-3 px-2 rounded-lg bg-white border border-gray-400 whitespace-nowrap hover:bg-gray-50 focus:outline-none focus:ring-gray-100 focus:ring-4">
