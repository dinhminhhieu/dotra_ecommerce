...
const SellerDetails = () => {
  ...
  const { seller_info, success_message, error_message } = useSelector(
    (state) => state.seller
  );
  ...
  return (
    <div className="px-2 lg:px-7 pt-5 bg-[#dae1e7]">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-3 pb-4 mt-2">
        <div className="bg-white rounded-md p-5">
          ...
          <div className="flex justify-start items-center mt-4">
            ...
            {seller_info.payment === "unactive" ? (
              <Badge color="failure">Chưa kích hoạt</Badge>
            ) : (
