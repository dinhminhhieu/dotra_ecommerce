          ...
          <main className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div className="w-full">
              ...
              <div className="gap-y-4 gap-x-6 justify-center items-center pt-5 whitespace-nowrap">
                <button className="flex w-full items-center justify-center mb-4 flex-1 py-3 px-2 rounded-lg bg-white border border-gray-400 whitespace-nowrap hover:bg-gray-50 focus:outline-none focus:ring-gray-100 focus:ring-4">
                  <FcGoogle className="w-6 h-6" />
                  <span className="pl-3 font-medium text-gray-900">
                    Đăng nhập bằng Google
                  </span>
                </button>
                <button className="flex w-full items-center justify-center flex-1 py-3 px-2 rounded-lg bg-blue-500 whitespace-nowrap hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-gray-100">
