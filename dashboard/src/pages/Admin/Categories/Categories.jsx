...
import {
  ...
  get_categories,
  message_clear,
} from "../../../store/reducers/category.reducers";
...
const Categories = () => {
  ...
  const { loading, success_message, error_message, categories, totalCategory } =
  ...
  //   .fill(0)
  //   .map((_, index) => ({
  //     tenDanhMuc: "Apple MacBook Pro 17",
  //     ngayTao: "20/11/2023",
  //     hinhAnh: "/src/assets/img/admin.png",
  //     hanhDong: [
  //       {
  //         id: "trash",
  //         component: <BsTrash size={22} className="text-cyan-600" />,
  //         to: "/",
  //       },
  //       {
  //         id: "eye",
  ...
  return (
    <div className="px-2 md:px-7 py-5 bg-[#dae1e7]">
      ...
      {/* <div className="overflow-x-auto mt-5">
        <DataTable headers={fields} data={data} />
      </div>
