...
const Chat = () => {
  ...
  return (
    <div className="px-2 lg:px-7">
      <div className="w-full bg-[#dae1e7] px-4 py-4 rounded-md h-[calc(100vh-90px)]">
        <div className="flex w-full h-full relative">
              ...
              {sellers.map((s, index) => (
                <Link
                  ...
                  className={`h-[50px] flex justify-start gap-2 items-center mt-3 px-2 py-2 rounded-xl cursor-pointer ${
                    sellerId === s._id ? "bg-slate-700 text-white" : ""
                  }`}
                >
          ...
          <div className="w-full md:w-[calc(100%-200px)] md:pl-4">
              ...
              {sellerId && (
                <div className="flex justify-start items-center gap-3">
                  <div className="relative">
                    ...
                    />
                    {activeSellers.some(
                      (a) => a.sellerId === current_seller._id
                    ) && (
                      <div className="w-[10px] h-[10px] bg-green-500 rounded-full absolute right-0 bottom-0"></div>
                    )}
                  </div>
                  <span>
                    {" "}
                    {current_seller.shop_info ? (
                      <h2 className="text-base">
                        {current_seller.name} (
                        {current_seller.shop_info.shop_name})
                      </h2>
                    ) : (
                      <h2 className="text-base">{current_seller.name}</h2>
                    )}
                  </span>
                </div>
              )}
            ...
            <div className="p-2">
              <div className="bg-white h-[calc(100vh-220px)] rounded-md p-3 overflow-y-auto">
                {sellerId ? (
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex flex-col gap-1">
                            <div className="flex flex-col w-full max-w-[300px] h-auto leading-1.5 p-3 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
                                            ...
                                            <div className="flex items-start my-2.5 bg-gray-50 dark:bg-gray-600 rounded-xl p-2">
                                              <div className="me-2">
                                                <span className="flex items-center gap-2 text-sm font-medium text-gray-900 dark:text-white pb-2">
                                                  ...
                                                  <span className="block overflow-hidden whitespace-nowrap overflow-ellipsis w-[200px]">
                                                    {fileName}
                                                  </span>
                                                </span>
                  ...
                  <div className="w-full h-full flex justify-center items-center flex-col font-bold gap-2 text-lg">
                    <span>
            ...
            <div className="flex p-2 justify-between items-center w-full">
              ...
              <div className="w-[calc(100%-90px)] rounded-full relative overflow-visible">
                <input
                  type="text"
                  value={fileName ? fileName + " " + message : message}
                  onChange={(e) => {
                    const newMessage = e.target.value;
                    const filePrefix = fileName ? fileName + " " : "";
                    if (newMessage.startsWith(filePrefix)) {
                      setMessage(newMessage.substring(filePrefix.length));
                    } else {
                ...
                <div className="absolute right-4 top-[50%] transform -translate-y-1/2 cursor-pointer">
                  ...
                  {showEmoji && (
                    <div className="absolute bottom-full -right-5 transform">
              ...
              <div
                ...
                className="w-[40px] p-2 justify-center items-center rounded-full"
              >
