...
import {
  activate_stripe_connect_account,
  message_clear,
...
const PaymentSuccess = () => {
  ...
  useEffect(() => {
    var end = Date.now() + 15 * 1000; // Thời gian kết thúc, tăng số này để confetti rơi lâu hơn

    // Màu sắc của cầu vồng
    var colors = ["#FF0000", "#FF7F00"];

    (function frame() {
      confetti({
        particleCount: colors.length, // Số lượng hạt confetti bằng với số màu trong mảng colors
        angle: 60,
        spread: 55,
        origin: { x: 0 },
        colors: colors,
