...
router.get(
  "/get-customers-chat/:sellerId",
  authMiddlewares,
  chatController.get_customers_chat
);

router.get(
  "/get-customer-seller-messages/:customerId",
  authMiddlewares,
...
router.post(
  ...
  authMiddlewares,
  chatController.send_message_seller_customer
);

router.post(
  "/send-message-seller-admin",
  authMiddlewares,
  chatController.send_message_admin_and_seller
);
...
router.get(
  "/get-sellers-chat",
  authMiddlewares,
  chatController.get_sellers_chat
);
