...
class orderController {
  ...
  place_order = async (req, res) => {
    ...
    for (let i = 0; i < products.length; i++) {
      ...
      for (let j = 0; j < productIndex.length; j++) {
        ...
        this.updateProductQuantity(
          productIndex[j].product_info._id,
          productIndex[j].quantity
        );
    ...
    try {
      ...
      response(res, httpStatusCode.Ok, {
        message: successMessage.ORDER_SUCCESS,
        data: order.id,
      });
    } catch (error) {
  ...
  // 2. Lấy thông tin đơn hàng trả về customer
  ...
  // 3. Lấy thông tin chi tiết đơn hàng trả về customer
  ...
  // 4. Lấy thông tin đơn hàng trả về admin
  ...
  // 5. Lấy thông tin chi tiết đơn hàng trả về admin
  ...
  // 6. Admin thay đổi trạng thái đơn hàng
  ...
  // 8. Lấy danh sách đơn hàng trả về seller
  ...
  // 9. Lấy thông tin chi tiết đơn hàng trả về seller
  ...
  // 10. Seller thay đổi trạng thái đơn hàng
