...
class couponsController {
  ...
  add_coupons = async (req, res) => {
    const { coupons_name, coupons_code, coupons_price, start_day, end_date } =
      req.body;
    try {
      ...
      response(res, httpStatusCode.Created, {
        message: successMessage.ADD_COUPONS_SUCCESS,
        data: new_coupons,
      });
    } catch (error) {
  ...
  update_coupons = async (req, res) => {
    ...
    try {
      ...
      response(res, httpStatusCode.Ok, {
        message: successMessage.UPDATE_COUPONS_SUCCESS,
        data: coupons,
      });
    } catch (error) {
      response(res, httpStatusCode.InternalServerError, {
  ...
  delete_coupons = async (req, res) => {
    ...
    try {
      ...
      response(res, httpStatusCode.Ok, {
        message: successMessage.DELETE_COUPONS_SUCCESS,
        data: coupons,
      });
    } catch (error) {
      response(res, httpStatusCode.InternalServerError, {
